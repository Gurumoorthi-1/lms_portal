...
export default function DeepAnalytics() {
  ...
  if (loading) return <HodLayout><AnalyticsSkeleton /></HodLayout>;
          ...
          <>
                  ...
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={data.engagementData}>
                      ...
                      <Tooltip 
                        contentStyle={{ backgroundColor: '#fff', border: '1px solid #E2E8F0', borderRadius: '12px', boxShadow: '0 4px 6px -1px rgb(0 0 0 / 0.1)' }}
                      />
                      <Bar dataKey="active" fill="#F97316" radius={[6, 6, 0, 0]} name="Active Students" />
                      <Bar dataKey="exams" fill="#F97316" radius={[6, 6, 0, 0]} name="Exams Taken" />
                    </BarChart>
                    </ResponsiveContainer>
                  )}
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                { label: 'Engagement Score', value: data.engagementScore || '0/10', icon: TrendingUp, color: 'text-orange-500' },
